...
(function () {
  ...
  var form_to_submit = document.getElementById("_form_671_");

  var allInputs = form_to_submit.querySelectorAll("input, select"),
    tooltips = [],
    submitted = false;
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      document.querySelector("#_form_671_submit").disabled = true;

      var serialized = _form_serialize(
        document.getElementById("_form_671_")
      ).replace(/%0A/g, "\\n");
...
(function () {
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var submitButton = e.target.querySelector("#_form_671_submit");
...
const calculate = () => {
  let price;
  if (calculator.rati === 1) {
    price = calculator.type;
  } else {
    price = Math.round(Number(calculator.type) / Number(calculator.rati));
  }
  calculatorPrice.innerHTML = `Monthly Payment<br /><strong>${price}€</strong>`;
...
(function () {
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var serialized = _form_serialize(
        document.getElementById("_form_270_")
      ).replace(/%0A/g, "\\n");
...
window._show_pc_confirmation = function (id, header, detail, show, email) {
  ...
  hideButton.addEventListener("click", function () {
    var submitButton = document.querySelector("#_form_671_submit");
    submitButton.disabled = false;
    submitButton.classList.remove("processing");
    var mp = document.querySelector('input[name="mp"]');
    mp.value = "1";
  ...
  script.onerror = function () {
    if (isSubmit) {
      if (script.src.length > 10000) {
        ...
        _show_error("671", "Sorry, your submission failed. Please try again.");
      }
      submitButton.disabled = false;
      submitButton.classList.remove("processing");
    }
